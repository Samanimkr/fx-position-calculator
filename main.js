...
const calculate = () => {
    const accountSize = document.getElementsByName('accountsize')[0];
    const pips = document.getElementsByName('pips')[0];
    ...
    const riskPercentage = document.getElementsByName('riskpercentage')[0];
    ...
    .then(({ data }) => console.log('data: ', data['Realtime Currency Exchange Rate']))
